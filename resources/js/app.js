...
let routes = [
  ...
  { path: '/mailer', component: require('./components/Mailer.vue').default }
]
...
/*moment filter*/
Vue.filter('momDate',function(created){
...
const app = new Vue({
    ...
    router,
    data: {
      // global search input on adminpanel.blade.php
      search: ''
    },
    methods: {
